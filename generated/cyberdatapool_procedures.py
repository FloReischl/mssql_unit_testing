from mrtest import DbCmd, Session
...
class CyberDataPoolDboProcedures:
    def __init__(self, cn: (Connection | str)):
        if isinstance(cn, Connection): self.cn = cn
        elif isinstance(cn, Session): self.cn = cn.cn
        else: create_engine(str(cn)).connect()
...
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'OutputTableName': OutputTableName, 'ColID': ColID })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'InputVariables': InputVariables })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'InputVariables': InputVariables, 'checkForExisting': checkForExisting, 'suppressOutput': suppressOutput })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColNameToCheck': ColNameToCheck })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColProcessID': ColProcessID })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColCodeStandard': ColCodeStandard, 'ColCodeNumber': ColCodeNumber, 'ColDescription': ColDescription })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColTag': ColTag, 'ColTagRole': ColTagRole })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColProcessID': ColProcessID, 'ColProduct': ColProduct })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColProcessID': ColProcessID, 'ColReserveAmount': ColReserveAmount, 'ColSignalReserve': ColSignalReserve })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColState': ColState, 'ColCountry': ColCountry })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'getCompanyID': getCompanyID })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'ColCurrency': ColCurrency, 'ColTurnover': ColTurnover, 'ColInceptionDate': ColInceptionDate, 'ColCompClientInfoID': ColCompClientInfoID, 'ColProcessID': ColProcessID, 'ColDelete': ColDelete })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'diagramname': diagramname, 'owner_id': owner_id })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'InputTableName': InputTableName, 'InputVariables': InputVariables, 'autoAdd': autoAdd })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'target_table': target_table, 'temp_table': temp_table })
...
SELECT @_return_value [return_value];
"""
        return DbCmd(self.cn, sql, { 'Session_ID': Session_ID, 'InputVariables': InputVariables })

    def usp_merge_Dim_Claim_Status(self, Session_ID: UUID, InputVariables: str) -> DbCmd:
        sql = """
DECLARE @_return_value INT;
DECLARE @Session_ID uniqueidentifier = :Session_ID;
DECLARE @InputVariables nvarchar(max) = :InputVariables;

EXECUTE @_return_value = [dbo].[usp_merge_Dim_Claim_Status]
    @Session_ID = @Session_ID
    ,@InputVariables = @InputVariables;
...
"""
    ...
    def usp_merge_Dim_Client_Name_Hierarchy_Level(self, Session_ID: UUID, InputVariables: str) -> DbCmd:
        sql = """
DECLARE @_return_value INT;
DECLARE @Session_ID uniqueidentifier = :Session_ID;
DECLARE @InputVariables nvarchar(max) = :InputVariables;

EXECUTE @_return_value = [dbo].[usp_merge_Dim_Client_Name_Hierarchy_Level]
    @Session_ID = @Session_ID
    ,@InputVariables = @InputVariables;
...
"""
    ...
    def usp_merge_Dim_Currency(self, Session_ID: UUID, InputVariables: str) -> DbCmd:
        sql = """
DECLARE @_return_value INT;
DECLARE @Session_ID uniqueidentifier = :Session_ID;
DECLARE @InputVariables nvarchar(max) = :InputVariables;

EXECUTE @_return_value = [dbo].[usp_merge_Dim_Currency]
    @Session_ID = @Session_ID
    ,@InputVariables = @InputVariables;
