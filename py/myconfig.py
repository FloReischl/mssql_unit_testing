...
# connectionString = f'DRIVER={{SQL Server}};SERVER=(local);DATABASE=testdb;Trusted_Connection=Yes'
# connectionString = 'DRIVER={SQL Server};SERVER=.;DATABASE=testdb;Trusted_Connection=Yes;'
